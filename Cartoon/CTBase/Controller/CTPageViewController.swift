...
enum CTPageStyle {
    case none, navigationBarSegment, topTabBar
}

class CTPageViewController: CTBaseViewController {
...
extension CTPageViewController: UIPageViewControllerDataSource, UIPageViewControllerDelegate {
    ...
    func pageViewController(_ pageViewController: UIPageViewController, viewControllerAfter viewController: UIViewController) -> UIViewController? {
        guard let index = vcs.firstIndex(of: viewController) else { return nil }
        let after = index + 1
        guard after <= vcs.count - 1 else { return nil}
        return vcs[after]
    }
    ...
    func pageViewController(_ pageViewController: UIPageViewController, didFinishAnimating finished: Bool, previousViewControllers: [UIViewController], transitionCompleted completed: Bool) {
        ...
        guard titles != nil && pageStyle == CTPageStyle.none else { return }
